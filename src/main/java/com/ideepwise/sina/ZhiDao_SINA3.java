...
public class ZhiDao_SINA3 {
	...
	public static void runSpider(String data,String file){
		String jarFilePath = ZhiDao_SINA3.class.getProtectionDomain().getCodeSource().getLocation().getFile();  
